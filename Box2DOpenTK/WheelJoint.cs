...
namespace Box2DOpenTK
{
    ...
    {
        void b2WheelJoint_EnableSpring(JointId jointId, bool enableSpring)
        {
            JointSim joint = GetJointSimCheckType(jointId, wheelJoint);
        ...
        bool WheelJoint_IsSpringEnabled(JointId jointId)
        {
            JointSim joint = GetJointSimCheckType(jointId, wheelJoint);
            return joint.wheelJoint.enableSpring;
        }

        void b2WheelJoint_SetSpringHertz(JointId jointId, float hertz)
        {
            JointSim joint = GetJointSimCheckType(jointId, wheelJoint);
